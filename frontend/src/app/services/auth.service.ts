...
import { environment } from '../../environments/environment'; // manquant dans ta version
...
export class AuthService {
  private apiUrlLogin = `${environment.apiUrl}/utilisateurs/login`; 
  private apiUrlLogout = `${environment.apiUrl}/utilisateurs/logout`; 
